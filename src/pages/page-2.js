...
const SecondPage = () => (
  <Layout>
    ...
    <br/>
      ...
      <img className="enterprise-image" alt="enterprise" src={Enterprise} />
      <p><b>Technologies Used:</b><br/>
      </br>ReactJS, Ruby, Rails Framework</p>
      ...
      and assisting in setting up Models, Views and Controllers for the Rails portion of the app.</p>
